...
# Create sample data for employees, departments, and tasks
    employees_data = [
            {"name": fake.name(),"username": fake.email(), "password":fake.name(), "admin": False, "tasks": ["ICQA Primary", "In-Bound SOUTH"], "departments": ["ICQA", "INDUCT"]},
            {"name": fake.name(),"username": fake.email(), "password":fake.name(), "admin": True,"tasks": ["ICQA SouthWest", "Task 3"], "departments": ["Department 2"]},
            {"name": fake.name(),"username": fake.email(), "password":fake.name(), "admin": False, "tasks": ["ICQA South", "ICQA North"], "departments": ["ICQA", "In-Bound", "Out-Bound"]},
        ]
